...
@Injectable()
export class PetAddPetFormService extends YASAGPostFormService<string> {
  constructor(
    apiConfigService: APIConfigService,
    ngZone: NgZone,
    private service: PetService,
  ) {
    super('PetAddPet', apiConfigService, ngZone);
  ...
  submit(value: any = false): Observable<string> {
    const result = this.service.addPet(value || this.form.value, this.multipart);
