...
function detectVersion(schema) {
    ...
    if (schema.apis && Array.isArray(schema.apis))
        return 'swagger1';
    if (schema.apiVersion && schema.basePath && !schema.openapi)
        return 'swagger1';
    ...
    if (schema.definitions)
        return 'swagger2';
    if (schema.securityDefinitions)
        return 'swagger2';
    if (schema.host && schema.paths)
        return 'swagger2';
...
//# sourceMappingURL=openapi-detector.js.map